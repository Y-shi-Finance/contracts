...
library LayerZeroPacket {
    ...
    function getPacketV2(bytes memory data, uint sizeOfSrcAddress, bytes32 ulnAddress) internal pure returns (LayerZeroPacket.Packet memory) {
    ...
    function getPacketV3(bytes memory data, uint sizeOfSrcAddress, bytes32 ulnAddress) internal pure returns (LayerZeroPacket.Packet memory) {
